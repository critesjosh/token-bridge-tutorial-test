...
import TokenBridgeContractArtifactJson from '../../aztec-contracts/token_bridge_contract/target/token_bridge_contract-TokenBridge.json' assert { type: 'json' };
...
export class TokenBridgeContract extends ContractBase {
   ...
   */
  public static deployWithPublicKeys(publicKeys: PublicKeys, wallet: Wallet, token: AztecAddressLike, portal_address: EthAddressLike) {
  ...
  public declare methods: {
    ...
    /** claim_private(recipient: struct, amount: field, secret_for_L1_to_L2_message_consumption: field, message_leaf_index: field) */
    claim_private: ((recipient: AztecAddressLike, amount: FieldLike, secret_for_L1_to_L2_message_consumption: FieldLike, message_leaf_index: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
